...
public interface PostRepository {
    ...
    @Insert("INSERT INTO posts (user_id, content, status, created_at, updated_at, deadline) VALUES (#{post.user_id}, #{post.content},'未完了', #{post.created_at}, #{post.updated_at}, #{post.deadline});")
